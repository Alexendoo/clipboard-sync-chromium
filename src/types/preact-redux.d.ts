// https://github.com/developit/preact-redux/pull/20
declare module 'preact-redux' {
  ...
  interface ComponentMergeDecorator<TMergedProps, TOwnProps> {
    (component: Component<TMergedProps, any>): ComponentConstructor<
      TOwnProps,
      any
    >
  }
   ...
   * @param options
   */
  export function connect(): ComponentDecorator<DispatchProp<any>>
